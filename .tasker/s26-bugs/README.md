...
- [x] [s26t01](s26t01-bug-when-searching-for-tasker.md): BUG: when searching for 'tasker' dir we should not pass '.git' directory -- it's clearly out of package
- [x] [s26t02](s26t02-bug-q-can-reference-deleted.md): BUG: (q) can reference deleted task, it should not fail in this case
...
- [x] [s26t18](s26t18-open-tasks-list-should-be.md): Open tasks list should be grouped
- [x] [s26t19](s26t19-adding-to-todo-must-show/): Adding to todo must show only updated todo list, not all opened
